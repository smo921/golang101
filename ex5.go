...
func main() {
	...
	b = [10]int{1, 2, 3, 4, 5}
	fmt.Println("\nLength of array B: ", len(b))
	fmt.Println("Capacity of array B: ", cap(b))
	fmt.Println("B: ", b)

	c := b[0:5]
	fmt.Println("\nLength of slice C: ", len(c))
	fmt.Println("Capacity of slice C: ", cap(c))
	fmt.Println("C: ", c)
	...
	fmt.Println("\nNow lets make D a new slice, twice the capacity of C and copy C into D")
